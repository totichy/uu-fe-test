function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uu_frontendOneg01-uu5lib/uu_frontendOneg01-uu5lib@0.1.0");
  styleEl.setAttribute("data-emotion", "uufrontendoneuulib");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  let els = insertionEl.querySelectorAll(`style[data-emotion="uufrontendoneuulib"]`);
